                ...
                <div className='projects flex flex-col'>
                    ...
                    <div className='project flex justify-between items-center'>
                        <div className='desc flex flex-col justify-center'>
                            ...
                            <div className='box'>
                                <p className='description'>Mesmerizing Front-End Design, Unleash Your Senses. Indulge in a sensory journey through our captivating fragrance shop website. Immerse yourself in an enchanting website that captures the essence of scent and allure.</p>
                            </div>
                            <div className='stacks flex'>
                                <h4 className='stackk'>Firebase</h4>
                                <h4 className='stackk'>Django</h4>
